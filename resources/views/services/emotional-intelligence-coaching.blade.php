...
@section('title','Emotional Intelligence Coaching — ' . config('app.name', 'Vivek For You'))
...
@section('content')
  <main class="max-w-6xl mx-auto p-6 lg:p-12">
    @include('partials.breadcrumb', ['items' => [
      ['label' => 'Home', 'url' => url('/')],
      ['label' => 'Emotional Intelligence Coaching']
    ]])

    <h1 class="text-3xl lg:text-4xl font-extrabold leading-tight">Emotional Intelligence Coaching</h1>
    <p class="mt-4 text-gray-600">Build self-awareness, regulation, and emotional clarity through coaching and practical exercises that strengthen emotional skills.</p>
    ...
    <section class="bg-white rounded-lg shadow p-8 mt-8">
      <h2 class="text-xl font-semibold mb-3" data-i18n="whatThisOffersTitle">Strengthen emotional skills</h2>
      <p class="text-gray-700 mb-4" data-i18n="service5Text">Training and coaching to improve emotional vocabulary, regulation tools, reflective habits, and relational application.</p>
